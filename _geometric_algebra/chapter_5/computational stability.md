...
The chapter’s Gaigen2 example illustrates this by probing when the join of two nearly parallel vectors changes from “vector” to “bivector,” with the transition occurring at the library’s internal epsilon scale (about $10^{-7}$ in the example). Use [[piecewise linearity and degeneracy]] for the geometric “wrong join” diagnostic, and design downstream code to handle regime switches explicitly.
