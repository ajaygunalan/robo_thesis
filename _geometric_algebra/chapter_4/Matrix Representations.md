...
So "transforming areas/volumes" in coordinates is literally "taking minors," which matches the geometric meaning of $\wedge$.

## Practical note
If you apply the same $f$ many times, precomputing these outermorphism matrices can beat recomputing wedge/contraction expressions. Conceptually, it's still the same object—just compiled into coordinates.
